...
const Activity = ({ amount, imgUrl, symbol, type, from, to, timestamp }: activityProps) => {
    ...
    return (
        <div className='flex w-full items-center gap-2 cursor-pointer transition-all duration-300 py-2 px-4 rounded-md hover:bg-primary/10'>
